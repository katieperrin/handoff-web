      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            Designer bags you own but rarely use are just sitting there. With The Handoffs, your luxury bags work for you. Members earn $60/month in credits while their bag is in the pool. Not a member? Earn $50/month cash while your bag is actively rented. You can also list for sale — renters try it first and buy it outright.
          </p>
